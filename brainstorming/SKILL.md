---
name: brainstorming
description: "You MUST use this skill before any creative or technical work — creating features, building components, adding functionality, modifying behavior, designing systems, or planning any project. Use it whenever the user says things like 'I want to build', 'help me design', 'let's plan', 'I have an idea for', 'create a feature', 'add functionality', or 'how should I structure'. This skill explores user intent, requirements, and design through collaborative dialogue BEFORE any implementation begins. Even for seemingly simple requests, always run through this process — unexamined assumptions in 'simple' projects cause the most wasted work."
---
...
3. You have written and the user has reviewed the spec doc
